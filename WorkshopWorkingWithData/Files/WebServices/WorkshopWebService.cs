...
namespace WorkshopWorkingWithData
{
	...
	public class WorkshopWebService : BaseService
	{
		...
		{
			//http://localhost:9080/0/rest/WorkshopWebService/GetAllContacts?qt=0
			Timer.Start();
		...
		{
			//http://localhost:9080/0/rest/WorkshopWebService/GetFilteredContacts?qt=0&email=a.baker@ac.com	
			Timer.Start();
			Tuple<DataTable, string> result;
			switch (qt)
			{
