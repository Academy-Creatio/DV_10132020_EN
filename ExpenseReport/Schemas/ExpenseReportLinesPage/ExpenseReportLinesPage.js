define("ExpenseReportLinesPage", [], function() {
	return {
		...
		messages: {
			//SubscribedOn: ExpenseReportPage (package: ExpenseReport)
		...
		methods: {
			onAmountFCChanged: function(){
				//this.save();
				//this.sandbox.publish("ExpenseReportLineAmountFcChanged", "message body", ["THIS_IS_MY_TAG2"]);
			},
			onAmountHCChanged: function(){
				//this.save();
				//this.sandbox.publish("ExpenseReportLineAmountHcChanged", "message body", ["THIS_IS_MY_TAG2"]);
			},
			save: function(){
